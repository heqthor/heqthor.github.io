function Torre(textura){ 
    ...
    this.pie1= new THREE.Mesh(new THREE.BoxGeometry(10,10,25),new THREE.MeshBasicMaterial({color: 0xff0000}));
    this.pie2= new THREE.Mesh(new THREE.BoxGeometry(10,10,25),new THREE.MeshBasicMaterial({color: 0xff0000}));
